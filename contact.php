...
// Tangani POST request melalui AJAX
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Simpan ke database
    $sql = "INSERT INTO messages (name, phone, message, created_at) 
...
<head>
  ...
  <title>PT Asiatek Indo Makmur | Contact Us</title>
...
<body>
  ...
  <section class="about-hero" 
           style="background-image:url('img/contact.jpeg');background-size:cover;background-position:center;">
    <div class="about-hero-overlay">
      <div class="about-hero-content container">
        <h1>Contact Us</h1>
        <p>
          Jika Anda membutuhkan bantuan atau informasi lebih lanjut, kami siap membantu Anda dengan solusi terbaik.
